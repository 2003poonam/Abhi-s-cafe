...
<section class="menu" id="menu">
    <div class="container">
    <div class="heading3">Pasta <span>Menu</span></div>
  </div>
    <div class="container" id="container2">
    <div class="row">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/eggpasta.jpg" alt="">
          <div class="card-body">
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/macaronipasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/orzopasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/rotellepasra.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
    ...
    <div class="row" style="margin-top: 50px;">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/ditapasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/rotinipasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/Bucatinipasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/rigatonipasta.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
