...
<section class="menu" id="menu">
    <div class="container">
    <div class="heading3">Creme Shakes <span>Menu</span></div>
  </div>
    <div class="container" id="container2">
    <div class="row">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/badamshake.jpg" alt="">
          <div class="card-body">
            ...
            <h3>Badam <br> Shake</h3>
            <p>Rs.20 <strike>Rs.40</strike></p>
          </div>
        </div>
      </div>
      <div class="col-md-3 py-3 py-md-0">
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/blueberryshake.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
            ...
            <h3>Blueberry <br>Milkshake</h3>
            <p>Rs.70 <strike>Rs.80</strike></p>
          </div>
        </div>
      </div>
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/mangoshake.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
    ...
    <div class="row" style="margin-top: 50px;">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/strawshake.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/pineappleshake.gif" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/vanillashake.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/pistashake.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
