...
<section class="menu" id="menu">
    <div class="container">
    <div class="heading3">Burger <span>Menu</span></div>
  </div>
    <div class="container" id="container2">
    <div class="row">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/vegbur.jpg" alt="">
          <div class="card-body">
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h3>Cheese <br> Burger</h3>
            <p>Rs.60 <strike>Rs.100</strike></p>
          </div>
        </div>
      </div>
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/chiceknbur.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
    ...
    <div class="row" style="margin-top: 50px;">
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/crispychickenburger.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
            ...
            <h3>Crunchy Chicken <br> Burger</h3>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/specialburger.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
              <i class="fa-solid fa-star"></i>
              <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/paneerburger.jpg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
      ...
      <div class="col-md-3 py-3 py-md-0">
        <div class="card">
          <img src="./images/baconburger.jpeg" alt="">
          <div class="card-body">
            <div class="star text-center">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
